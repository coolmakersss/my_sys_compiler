...
public class Lor extends Binary {
    public Lor(String assigned, String a, String b) {
        kind = IRKind.OR_BIN;
    ...
    public void print(OutputStreamWriter writer) throws IOException {
        writer.append("lor ").append(assigned).append(" ").append(integer1).append(" ").append(integer2).append("\n");
    }
    ...
    public void assembly(OutputStreamWriter writer, Function function) throws IOException {
        ...
        if(assigned.charAt(0) == '$'){
            writer.append("or ").append(assigned).append(", ").append(integer1).append(", ").append(integer2).append("\n");
        } else {
            writer.append("or $27, ").append(integer1).append(", ").append(integer2).append("\n");
