...
public class Less extends Binary {
    public Less(String tmp, String tmp1, String res) {
        kind = IRKind.GT_BIN;
        this.assigned = tmp;
        this.integer1 = tmp1;
        this.integer2 = res;
    ...
    public void print(OutputStreamWriter writer) throws IOException {
        writer.append("less ").append(assigned).append(" ").append(integer1).append(" ").append(integer2).append("\n");
    }
    ...
    public void assembly(OutputStreamWriter writer, Function function) throws IOException {
        ...
        if(assigned.charAt(0) == '$'){
            if(integer2.charAt(0) == '$'){
                writer.append("slt ").append(assigned).append(", ").append(integer1).append(", ").append(integer2).append("\n");
            } else {
            ...
            if(integer2.charAt(0) == '$'){
                writer.append("slt $27, ").append(integer1).append(", ").append(integer2).append("\n");
            } else {
                writer.append("li $28, ").append(integer2).append("\n");
                integer2 = "$28";
                writer.append("slt $27, ").append(integer1).append(", ").append(integer2).append("\n");
