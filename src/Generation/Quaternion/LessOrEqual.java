...
public class LessOrEqual extends Binary {
    public LessOrEqual(String tmp, String tmp1, String res) {
        kind = IRKind.GT_BIN;
        this.assigned = tmp;
        this.integer1 = tmp1;
        this.integer2 = res;
    ...
    public void print(OutputStreamWriter writer) throws IOException {
        writer.append("lessOrEqual ").append(assigned).append(" ").append(integer1).append(" ").append(integer2).append("\n");
    }
    ...
    public void assembly(OutputStreamWriter writer, Function function) throws IOException {
        ...
        if(assigned.charAt(0) == '$'){
            writer.append("sle ").append(assigned).append(", ").append(integer1).append(", ").append(integer2).append("\n");
        } else {
            writer.append("sle $27, ").append(integer1).append(", ").append(integer2).append("\n");
