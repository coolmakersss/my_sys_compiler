...
public class NotLogic extends Binary {
    String assigned;
    String integer;
    public NotLogic(String tmp, String res) {
        kind = IRKind.NOT_UNI;
        assigned = tmp;
        integer = res;
    }
    ...
    public void print(OutputStreamWriter writer) throws IOException {
        writer.append("not ").append(assigned).append(" ").append(integer).append("\n");
    }
    ...
    public void assembly(OutputStreamWriter writer, Function function) throws IOException {
        ...
        if(assigned.charAt(0) == '$'){
            writer.append("seq ").append(assigned).append(", $0, ").append(integer).append("\n");
        } else {
            writer.append("seq $27, $0, ").append(integer).append("\n");
