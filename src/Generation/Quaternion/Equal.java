...
public class Equal extends Binary {
    ...
    public Equal(String tmp, String a, String b) {
        kind = IRKind.EQ_BIN;
        this.assigned = tmp;
        this.integer1 = a;
        this.integer2 = b;
    ...
    public void print(OutputStreamWriter writer) throws IOException {
        writer.append("equal ").append(assigned).append(" ").append(integer1).append(" ").append(integer2).append("\n");
    }
    ...
    public void assembly(OutputStreamWriter writer, Function function) throws IOException {
        ...
        if(assigned.charAt(0) == '$'){
            writer.append("seq ").append(assigned).append(", ").append(integer1).append(", ").append(integer2).append("\n");
        } else {
            writer.append("seq $27, ").append(integer1).append(", ").append(integer2).append("\n");
