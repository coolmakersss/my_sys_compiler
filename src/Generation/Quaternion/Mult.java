...
public class Mult extends Binary {
    public Mult(String assigned, String a, String b) {
        kind = IRKind.MUL_BIN;
    ...
    public void print(OutputStreamWriter writer) throws IOException {
        writer.append("mult ").append(assigned).append(" ").append(integer1).append(" ").append(integer2).append("\n");
    }
    ...
    public void assembly(OutputStreamWriter writer, Function function) throws IOException {
        ...
        if(assigned.charAt(0) == '$'){
            writer.append("mul ").append(assigned).append(", ").append(integer1).append(", ").append(integer2).append("\n");
        } else {
            writer.append("mul $27, ").append(integer1).append(", ").append(integer2).append("\n");
