...
public enum SyntaxKind {
    ...
    UNARY_EXP, MUL_EXP, UNARY_OP, FUNC_R_PARAMS, PRIMARY_EXP, NUMBER, LVAL, COND, LOR_EXP, LAND_EXP, EQ_EXP, REAL_EXP, PRINTF_STMT, RETURN_STMT, CONTINUE_STMT, BREAK_STMT, WHILE_STMT, IF_STMT;
